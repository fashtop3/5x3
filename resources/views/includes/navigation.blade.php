    ...
    <div class="container" style="padding:8px; padding-top:12px;">
        ...
        <div class="collapse navbar-collapse" id="this-navbar-collapse">
            <ul class="nav navbar-nav navbar-right">
                ...
                @if (Auth::check())
                    <li class=" dropdown">
                    <a href="#" class="dropdown-toggle btn btn-info" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-user"></i>Username<span class="caret"></span></a>
