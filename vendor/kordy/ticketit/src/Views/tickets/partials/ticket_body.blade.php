...
{{-- // END Modal Window: 1/2 --}}
            ...
            <div class="panel well well-sm">
                <div class="panel-body">
                    <div class="col-md-12">
                        <div class="col-md-6">
                            <p> <strong>{{ trans('ticketit::lang.owner') }}</strong>{{ trans('ticketit::lang.colon') }} <ins>{{ $ticket->user->profile->name }} <small>({{ $ticket->user->email }})</small></ins></p>
                            <p>
                        ...
                        <div class="col-md-6">
                            <p> <strong>{{ trans('ticketit::lang.responsible') }}</strong>{{ trans('ticketit::lang.colon') }}{{ $ticket->agent->username }}</p>
                            <p>
